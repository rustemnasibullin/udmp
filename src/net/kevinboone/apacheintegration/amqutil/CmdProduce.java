...
public class CmdProduce extends Cmd
{
  ...
  public int run() throws Exception
    ...
    String file = null; // No default -- if not given, don't read/write file
    String text = null; // No default -- if not given, don't read/write file
    ...
    String _text = cl.getOptionValue ("text");
    ...
    if (file != null) { 
        message = JMSUtil.makeMessage (session, file, length, type);
    } else if (text != null) {
        message = JMSUtil.makeTextMessage (session, text);
    }

package org.mtt.rservice.widgets;
...
import org.mtt.rservice.core.MAPIServiceHandler;
import org.mtt.webapi.core.IConstants;
import org.mtt.webapi.core.IWidgetCommand;
...
public class StatusPageWidgetCommand  implements IWidgetCommand {
    ...
    public void execute(Map<String, List<String>> pars) {
           ...
           if (xs1 != null && xs1.size()>0 && xs1.get(0).trim().length()>0) {
               ...
               "<td><td id=\"icon01\" style=\"background-color:'CornSilk';\">&nbsp;&nbsp;<a href=\"javascript:cleanColor('icon02');fillColor('icon01');displayOff('BI_002');displayOn('BI_001');\">" +
                IConstants._FREQ+"&nbsp;&nbsp;</a></td>" +
               "<td id=\"icon02\">&nbsp;&nbsp;<a href=\"javascript:cleanColor('icon01');fillColor('icon02');displayOff('BI_001');displayOn('BI_002');\">" +
                IConstants._RESPT+"</a>&nbsp;&nbsp;</td>" +
               "</tr></table>";
    ...
    double getAvFactor (String mapiId) {
                           ...
                           if (!useFake) {
            XUtils.plog("log/_getAvFactor.log","getAvFactor: "+s+" : "+mapiId);    
    ...
    public String print () {
           ...
           String s = "<html><body>" +
                      ...
                      Set <String> ms = MAPIServiceHandler.getMethods();
                      ...
                      Date ds = new Date();
                      Date ds0 = new Date();
                      ds0.setTime(ds.getTime() - _PAST_MIN*60*1000);
                      String  d1 = f.format(ds);
                      String  d0 = f.format(ds0);
                      String  d1s  =  "<input type=\"textfield\" name=\"DATESTART\" value=\""+d0+"\"     />\n";
                      String  d2s  =  "<input type=\"textfield\" name=\"DATEEND\"  value=\""+d1+"\"   />\n";
    ...
    String toTABUL(String method, String m1, SortedMap<Long,Double> D1, String m2, SortedMap<Long,Double> D2, Date d1, Date d2, String host) {
           ...
           String s = "<table border=1><tr><td&nbsp;colspan=2>Statistics&nbsp;report&nbsp;for&nbsp;jWebApi&nbsp;function:&nbsp;" + method +
                      "&nbsp;c&nbsp;" + IConstants.frmt.format(d1)+"&nbsp;��&nbsp;" + IConstants.frmt.format(d2)+"&nbsp;by&nbsp;node&nbsp;"+host+"</td></tr>";

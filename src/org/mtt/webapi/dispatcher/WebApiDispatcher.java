...
public class WebApiDispatcher implements MinaRequestHandler, WebApiDispatcherMBean, IConstants
{
    ...
    public String[] getTrend(String meth) {
           List<Quantil> qs = sc.getTrend(meth); 
           int n = qs.size();
    ...
    public WebApiDispatcher() {
           ...
           try {
             ...
             started.set(true);
                XUtils.ilog ("log/_WebApiDispatcher.log","Started: "+portX);    

           } catch (Throwable e) {
                XUtils.ilog ("log/_WebApiDispatcher.log", XUtils.info(e));    
           }
           }
 ...
 //       xConn.commitTX(iTX);
    ...
    public void start() {
        ...
        try {
            ...
            started.getAndSet(true);
                ...
                XUtils.ilog ("log/_WebApiDispatcher.log", XUtils.info(ee));    
    ...
    public double getAvailabilityFactor() {
        ...
        XUtils.ilog("log/_webspidisp.log", "Test: "+V);
        log.debug("Test AF: " +V);

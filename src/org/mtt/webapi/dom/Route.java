...
public class Route extends XSmartObject  {
    ...
    public String toJSONString() {
        String xs =    "{" + XUtils.toJSONPair("id",id)+"," + XUtils.toJSONPair("type",type)+"," +
            XUtils.toJSONPair("to",to)+"," + XUtils.toJSONPair("server_id",server_id)+"," +
            XUtils.toJSONPair("cache_instance_id",cache_instance_id)+"," + XUtils.toJSONPair("spot_id",spot_id)+"," + XUtils.toJSONPair("from",from)+
                             "}";
       return xs;
    }

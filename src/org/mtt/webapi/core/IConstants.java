...
public interface IConstants {
    ...
    public final static int SMAX = 100;
    ...
    public final static double _AVFACTOR_THRESHOLD = 0.01;
    
    public static final String _XNotification = "XNotification";
    public static final String _XRepository = "XRepository";

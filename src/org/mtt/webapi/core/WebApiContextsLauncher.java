...
public class WebApiContextsLauncher  extends Thread {
       ...
       public WebApiContextsLauncher() {
        ...
        public static Object findBean (String nameOfBean) {
            ...
            Object xc = null;
            int i = 0;
        XUtils.ilog("log/WebApiContextsLauncher.log", "WebApiContextsLauncher: "+nameOfBean);
            for (ApplicationContext xs: contexts) {
            XUtils.ilog("log/WebApiContextsLauncher.log", "WebApiContextsLauncher: "+xs.getId());

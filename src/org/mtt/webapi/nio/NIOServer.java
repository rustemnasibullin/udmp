...
public class NIOServer {
    ...
    private void read(SelectionKey key) throws IOException {
        ...
        try {
          byte[] resdata = (byte[]) processor.process(data);
          ByteBuffer bytebuf = ByteBuffer.wrap(resdata);
          System.out.println("Got: " + new String(data));
          System.out.println("Send: " + resdata.length);
    ...
    class ProcessorImpl {
        ...
        public Object process (Object in) throws Exception {
               ...
               String path = "c:/home/jrc/fstorage/fst1/3285.wav";
